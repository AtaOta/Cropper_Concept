...
for (let resizer of resizers){
    ...
    function resizerMouseEvent(e){
        ...
        function mousemove(e){
            ...
            rectMaxBottom = ((imgWrapperRect.bottom - heightChange/2 + imgMoveY) >= (wrapperBottom)) ? (wrapperBottom):(imgWrapperRect.bottom - heightChange/2 - zoomingHeightChange/2 + imgMoveY);
